...
<body>
    <main>
        ...
        <form action="nova-conta.php" method="POST">
            <p>Nova conta</p>
            <input type="text" name="nome" placeholder=" Primeiro nome" id="nome">
            ...
            <input type="password" name="conf-senha" placeholder=" Confirme sua senha" id="conf-senha">
            <button type="submit" name="submit" onclick="cadastro()">Cadastrar</button>
        </form>
        <a href="index.html" id="fazer-login">
            <p>Fazer login</p>
        </a>
        <div id="msg"></div>
    </main>
